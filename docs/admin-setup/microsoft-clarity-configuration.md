...
# Microsoft Clarity
    ...
    ![env-file](../../static/img/adminPanel/microsoft-clarity-new-project.png)
    ...
    ![env-file](../../static/img/adminPanel/microsoft-clarity-project-id.png)
    ...
    ![env-file](../../static/img/adminPanel/microsoft-clarity-admin-settings.png)